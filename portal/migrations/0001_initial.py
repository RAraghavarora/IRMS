# Generated by Django 2.2.1 on 2019-06-21 04:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lang', models.CharField(blank=True, max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ic_number', models.CharField(max_length=25)),
                ('division', models.CharField(max_length=50)),
                ('mem_number', models.CharField(max_length=20)),
                ('ref_no_date', models.CharField(max_length=50, null=True)),
        ...
        migrations.CreateModel(
            name='Aqbasketusers',
            fields=[
                ('basketno', models.OneToOneField(db_column='basketno', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='portal.Aqbasket')),
            ],
            options={
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('budget', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='portal.Aqbudgets')),
            ],
            options={
                'managed': False,
        ...
        migrations.CreateModel(
            name='AqorderUsers',
            fields=[
                ('ordernumber', models.OneToOneField(db_column='ordernumber', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='portal.Aqorders')),
            ],
            options={
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('authtypecode', models.OneToOneField(db_column='authtypecode', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='portal.AuthTypes')),
                ('tagfield', models.CharField(max_length=3)),
                ('tagsubfield', models.CharField(max_length=1)),
                ('liblibrarian', models.CharField(max_length=255)),
                ('libopac', models.CharField(max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('borrower_message_preference', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='portal.BorrowerMessagePreferences')),
            ],
            options={
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('categorycode', models.OneToOneField(db_column='categorycode', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='portal.Categories')),
                ('maxissueqty', models.IntegerField(blank=True, null=True)),
                ('maxonsiteissueqty', models.IntegerField(blank=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('branchcode', models.OneToOneField(db_column='branchcode', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='portal.Branches')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('itemtype', models.OneToOneField(db_column='itemtype', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='portal.Itemtypes')),
                ('holdallowed', models.IntegerField(blank=True, null=True)),
                ('hold_fulfillment_policy', models.CharField(max_length=13)),
                ('returnbranch', models.CharField(blank=True, max_length=15, null=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('course', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='portal.Courses')),
            ],
            options={
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('itemnumber', models.OneToOneField(db_column='itemnumber', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='portal.Items')),
                ('item_level_request', models.IntegerField()),
            ],
            options={
                'managed': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('borrowernumber', models.OneToOneField(db_column='borrowernumber', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='portal.Borrowers')),
        ...
        migrations.CreateModel(
            name='HouseboundRole',
            fields=[
                ('borrowernumber', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='portal.Borrowers')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('illrequest', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='portal.Illrequests')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('message_attribute', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='portal.MessageAttributes')),
        ...
        migrations.CreateModel(
            name='Permissions',
            fields=[
                ('module_bit', models.OneToOneField(db_column='module_bit', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='portal.Userflags')),
                ('code', models.CharField(max_length=64)),
                ('description', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('search_marc_map', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='portal.SearchMarcMap')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('itemnumber', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='portal.Items')),
        ...
        migrations.CreateModel(
            name='TagsIndex',
            fields=[
                ('term', models.OneToOneField(db_column='term', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='portal.TagsApproval')),
        ...
        migrations.CreateModel(
            name='TransportCost',
            fields=[
                ('frombranch', models.OneToOneField(db_column='frombranch', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, related_name='sources_transport_costs', serialize=False, to='portal.Branches')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addressee', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ndcs', to='portal.Addressee')),
                ('patron', models.ManyToManyField(related_name='ndcs', to='portal.PatronInfo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(auto_now=True)),
                ('full_ref', models.CharField(max_length=40, null=True)),
                ('addressee', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fine_reports', to='portal.Addressee')),
                ('patron', models.ManyToManyField(related_name='fine_reports', to='portal.PatronInfo')),
            ],
            options={
